            ...
            return (
              <Fragment key={evaluacion.id}>
                <Table.Row
                  ...
                  aria-label={`Ver detalle de la evaluación del ${animalAccessibleName}`}
...
type SesionEvaluacionRowDetailProps = {
  evaluacion: EvaluacionCC;
  onEdit: () => void;
};

function SesionEvaluacionRowDetail({
  evaluacion,
  onEdit,
}: SesionEvaluacionRowDetailProps) {
